                  ...
                  <form>
                      ...
                      <div className="grid grid-cols-1 gap-4 m-5 mb-0">
                          <div className="mb-3 ">
                              ...
                              <select id="theme" className="transition-all drop-shadow-xl text-center bg-background border border-borderGray text-textPrimary text-sm rounded-lg block w-full p-2.5 focus:ring-borderPrimary focus:border-borderPrimary ">
