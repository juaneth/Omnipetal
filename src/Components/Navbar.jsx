    ...
    return (
        <div className="navbar p-0 min-h-12 bg-primary shadow-xl">
            <div className='pr-5 h-12 text-center align-middle draggable'>
                ...
                <h1 className='font-bold text-[11pt]'>Omnipetal</h1>
            </div>
            <div className="tabs h-full space-x-2 items-center">
                <Link className={activeTab == "home" ? "tab tab-active text-[11pt] hover:bg-neutral/50 rounded-lg transition-all" : "tab text-[11pt] hover:bg-neutral/50 rounded-lg transition-all"} onClick={() => setActiveTab('home')} to='/'>Home</Link>
                <Link className={activeTab == "servers" ? "tab tab-active text-[11pt] hover:bg-neutral/50 rounded-lg transition-all" : "tab text-[11pt] hover:bg-neutral/50 rounded-lg transition-all "} onClick={() => setActiveTab('servers')} to='/servers'>Servers</Link>
                <Link className={activeTab == "remotes" ? "tab tab-active text-[11pt] hover:bg-neutral/50 rounded-lg transition-all" : "tab text-[11pt] hover:bg-neutral/50 rounded-lg transition-all "} onClick={() => setActiveTab('remotes')} to='/remotes'>Remotes</Link>
            </div>

            <div className='draggable h-11 flex-grow'></div>
